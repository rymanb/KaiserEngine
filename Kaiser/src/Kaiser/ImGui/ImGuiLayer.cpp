...
Kaiser::ImGuiLayer::~ImGuiLayer()
{

}

void Kaiser::ImGuiLayer::OnAttach()
{
	...
	io.FontDefault = io.Fonts->AddFontFromFileTTF("c:\\Windows\\Fonts\\Arial.ttf", fontSize);
...
void Kaiser::ImGuiLayer::OnDetach()
{
...
void Kaiser::ImGuiLayer::SetDarkThemeColors()
{
